# 🏷️ v1.0.0 — In-Memory TTL Cache with Concurrency & Background Eviction

## 🚀 Overview
![alt text](<Screenshot 2026-01-20 161020.png>)

We’re excited to release **v1.0.0** — the first stable version of our in-memory caching layer designed for **performance**, **predictability**, and **safety** in concurrent Go applications.
...
- **ExpiryTime** — the exact timestamp when the item expires
...
- 🧹 Background eviction keeps memory usage in check
